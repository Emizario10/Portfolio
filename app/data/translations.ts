...
export const translations: Record<Language, Translation> = {
  es: {
    ...
    education: { sectionTitle: "EDUCACIÓN", items: [ { title: "Escuela Profesional de Economía (Informática)", date: "09/2022 – 07/2023", subtitle: "BBS1 Arnoldi-Schule", description: ["Enfoque en procesos económicos y TI."] }, { title: "Certificado de Educación Secundaria", date: "09/2021 – 07/2022", subtitle: "BBS1 Arnoldi-Schule", description: [] } ] },
  ...
  en: {
    ...
    education: { sectionTitle: "EDUCATION", items: [ { title: "Vocational School of Economics (IT)", date: "09/2022 – 07/2023", subtitle: "BBS1 Arnoldi-Schule", description: ["Focus on economic processes and IT."] }, { title: "Secondary School Certificate", date: "09/2021 – 07/2022", subtitle: "BBS1 Arnoldi-Schule", description: [] } ] },
  ...
  de: {
    ...
    education: { sectionTitle: "AUSBILDUNG", items: [ { title: "Berufsfachschule Wirtschaft (Informatik)", date: "09/2022 – 07/2023", subtitle: "BBS1 Arnoldi-Schule", description: ["Fokus auf wirtschaftliche Prozesse und IT."] }, { title: "Hauptschulabschluss", date: "09/2021 – 07/2022", subtitle: "BBS1 Arnoldi-Schule", description: [] } ] },
